...
class AccountsPayableController extends Controller
{
    ...
    public function indexAction(Request $request, $selectedMonth, $selectedYear)
    {
        ...
        return $this->render('CashFlowBundle:AccountsPayable:index.html.twig', array(
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('cashflow_accounts_payable_show', array('id' => $entity->getId())));
        }

        return $this->render('CashFlowBundle:AccountsPayable:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Accounts $entity)
    {
        ...
        $form = $this->createForm(new AccountsType(), $entity, array(
            'action' => $this->generateUrl('cashflow_accounts_payable_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        return $this->render('CashFlowBundle:AccountsPayable:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction(Request $request, $id)
    {
        ...
        return $this->render('CashFlowBundle:AccountsPayable:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new AccountsType(), $entity, array(
            'action' => $this->generateUrl('cashflow_accounts_payable_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $successUpdated = true;
            //return $this->redirect($this->generateUrl('cashflow_accounts_payable_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('cashflow_accounts_payable_home'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('cashflow_accounts_payable_delete', array('id' => $id)))
            ->setMethod('DELETE')
